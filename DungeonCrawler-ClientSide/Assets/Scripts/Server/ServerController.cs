...
public class ServerController : MonoBehaviour
{
	...
	void ListenForServer()
	{
		while (true)
		{
			...
			parts[1] = parts[1].Split(new[] { '\0' }, 2)[0];
			...
			switch (num)
			{
				case 1://Loggin answer  nconnected&&groupIndexname1/name2/../
					SignedInEvent();
					string[] moreParts = parts[1].Split(new[] { '/' }, 2);
					OnlineUsersUpdatedEvent(parts[1]);
					PlayerData.pData.mygroupIndex = Int32.Parse(moreParts[0].Split(new[] {'\0' }, 2)[0]);
					PlayerData.pData.temporalTeamIndex = -1;
					break;
				...
				case 4://Add connected player 
					...
					break;
				case 5://Update partners //5/Name1/Name2...
					string b = parts[1];
					string nuevoIndice = b.Split(new[] { '/' }, 2)[0];				
					
					PlayerData.pData.temporalTeamIndex = Int32.Parse(nuevoIndice);
					ModifyPartnersEvent(b.Split(new[] { '/' }, 2)[1]);
					break;
				case 6:
				...
				case 10://seed/pos/
					...
					EnemyListUpdateEvent(thirdPart[1]);//List of all groups
					break;
				...
				case 13: //Hemos entrado a una habitación y estaba vacía, aprovechar quizá para dar algún premio o spawnear algo para pelear or wtver
					...
					break;
				case 14://damage/target
					GetDamagedEvent(parts[1]);
					break;
